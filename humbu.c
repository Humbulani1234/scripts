...
static PyObject *
gentype_add_gen(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Add(self_op, m2);
        }
        else {
            res = PyNumber_Add(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.add);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.add);
        }
        Py_DECREF(other_op);
        return res;
    }
...
/* NOTE: We suffix the name for functions requiring special handling first. */
static PyObject *
gentype_multiply_gen(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Multiply(self_op, m2);
        }
        else {
            res = PyNumber_Multiply(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.multiply);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.multiply);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_subtract(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Subtract(self_op, m2);
        }
        else {
            res = PyNumber_Subtract(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.subtract);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.subtract);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_remainder(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Remainder(self_op, m2);
        }
        else {
            res = PyNumber_Remainder(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.remainder);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.remainder);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_divmod(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Divmod(self_op, m2);
        }
        else {
            res = PyNumber_Divmod(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.divmod);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.divmod);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_lshift(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Lshift(self_op, m2);
        }
        else {
            res = PyNumber_Lshift(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.left_shift);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.left_shift);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_rshift(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Rshift(self_op, m2);
        }
        else {
            res = PyNumber_Rshift(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.right_shift);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.right_shift);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_and(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_And(self_op, m2);
        }
        else {
            res = PyNumber_And(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.bitwise_and);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.bitwise_and);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_xor(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Xor(self_op, m2);
        }
        else {
            res = PyNumber_Xor(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.bitwise_xor);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.bitwise_xor);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_or(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_Or(self_op, m2);
        }
        else {
            res = PyNumber_Or(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.bitwise_or);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.bitwise_or);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_floor_divide(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_FloorDivide(self_op, m2);
        }
        else {
            res = PyNumber_FloorDivide(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.floor_divide);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.floor_divide);
        }
        Py_DECREF(other_op);
        return res;
    }
...
gentype_true_divide(PyObject *m1, PyObject *m2)
{
    ...
    if (self_op != NULL) {
        PyObject *res;
        if (self == m1) {
            res = PyNumber_TrueDivide(self_op, m2);
        }
        else {
            res = PyNumber_TrueDivide(m1, self_op);
        }
        Py_DECREF(self_op);
        return res;
    }
        ...
        PyObject *res;
        if (self == m1) {
            res = PyArray_GenericBinaryFunction(m1, other_op, n_ops.true_divide);
        }
        else {
            res = PyArray_GenericBinaryFunction(other_op, m2, n_ops.true_divide);
        }
        Py_DECREF(other_op);
        return res;
    }
...
legacy_cfloat_formatstr(npy_cfloat val)
{
     ...
     */
    if (npy_crealf(val) == 0.0 && npy_signbit(npy_crealf(val)) == 0) {
        PyOS_snprintf(format, sizeof(format), _FMT1, FLOATPREC_STR);
        res = NumPyOS_ascii_formatf(buf, sizeof(buf) - 1, format, npy_cimagf(val), 0);
        if (res == NULL) {
            PyErr_SetString(PyExc_RuntimeError, "Error while formatting");
            return NULL;
        }
        if (!npy_isfinite(npy_cimagf(val))) {
        ...
        if (npy_isfinite(npy_crealf(val))) {
            PyOS_snprintf(format, sizeof(format), _FMT1, FLOATPREC_STR);
            ...
            if (npy_isnan(npy_crealf(val))) {
                strcpy(re, "nan");
            }
            else if (npy_crealf(val) > 0){
                strcpy(re, "inf");
            }
            else {
                strcpy(re, "-inf");
        ...
        if (npy_isfinite(npy_cimagf(val))) {
            ...
            if (npy_isnan(npy_cimagf(val))) {
                strcpy(im, "+nan");
            }
            else if (npy_cimagf(val) > 0){
                strcpy(im, "+inf");
            }
            else {
                strcpy(im, "-inf");
...
legacy_cdouble_formatstr(npy_cdouble val)
{
     ...
     * Ideally, we should handle this nan/inf stuff in NumpyOS_ascii_format*
     */
    if (npy_creal(val) == 0.0 && npy_signbit(npy_creal(val)) == 0) {
        PyOS_snprintf(format, sizeof(format), _FMT1, DOUBLEPREC_STR);
        res = NumPyOS_ascii_formatd(buf, sizeof(buf) - 1, format, npy_cimag(val), 0);
        if (res == NULL) {
            PyErr_SetString(PyExc_RuntimeError, "Error while formatting");
            return NULL;
        }
        if (!npy_isfinite(npy_cimag(val))) {
            strncat(buf, "*", sizeof(buf) - strlen(buf) - 1);
        }
        strncat(buf, "j", sizeof(buf) - strlen(buf) - 1);
    }
        ...
        if (npy_isfinite(npy_creal(val))) {
            ...
            if (npy_isnan(npy_creal(val))) {
                strcpy(re, "nan");
            }
            else if (npy_creal(val) > 0){
                strcpy(re, "inf");
            }
            else {
                strcpy(re, "-inf");
        ...
        if (npy_isfinite(npy_cimag(val))) {
            ...
            if (npy_isnan(npy_cimag(val))) {
                strcpy(im, "+nan");
            }
            else if (npy_cimag(val) > 0){
                strcpy(im, "+inf");
            }
            else {
                strcpy(im, "-inf");
...
legacy_clongdouble_formatstr(npy_clongdouble val)
{
     ...
     * Ideally, we should handle this nan/inf stuff in NumpyOS_ascii_format*
     */
    if (npy_creall(val) == 0.0 && npy_signbit(npy_creall(val)) == 0) {
        PyOS_snprintf(format, sizeof(format), _FMT1, LONGDOUBLEPREC_STR);
        res = NumPyOS_ascii_formatl(buf, sizeof(buf) - 1, format, npy_cimagl(val), 0);
        if (res == NULL) {
            PyErr_SetString(PyExc_RuntimeError, "Error while formatting");
            return NULL;
        }
        if (!npy_isfinite(npy_cimagl(val))) {
            strncat(buf, "*", sizeof(buf) - strlen(buf) - 1);
        }
        strncat(buf, "j", sizeof(buf) - strlen(buf) - 1);
    }
        ...
        if (npy_isfinite(npy_creall(val))) {
            PyOS_snprintf(format, sizeof(format), _FMT1, LONGDOUBLEPREC_STR);
            ...
            if (npy_isnan(npy_creall(val))) {
                strcpy(re, "nan");
            }
            else if (npy_creall(val) > 0){
                strcpy(re, "inf");
            }
            else {
                strcpy(re, "-inf");
        ...
        if (npy_isfinite(npy_cimagl(val))) {
            ...
            if (npy_isnan(npy_cimagl(val))) {
                strcpy(im, "+nan");
            }
            else if (npy_cimagl(val) > 0){
                strcpy(im, "+inf");
            }
            else {
                strcpy(im, "-inf");
...
{
    PyObject *string;
    string = floattype_str_either(
            PyArrayScalar_VAL(self, Float),
    ...
    if (legacy_print_mode > 125) {
        Py_SETREF(string, PyUnicode_FromFormat("np.float32(%S)", string));
    }
#endif  /* IS_repr */
...
cfloattype_str(PyObject *self)
{
    ...
    if (npy_crealf(val) == 0.0 && npy_signbit(npy_crealf(val)) == 0) {
        istr = floattype_str_either(npy_cimagf(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
        ...
        if (legacy_print_mode <= 125) {
            ...
            ret = PyUnicode_FromFormat("np.complex64(%Sj)", istr);
        }
#endif  /* IS_repr */
        Py_DECREF(istr);
        return ret;
    ...
    if (npy_isfinite(npy_crealf(val))) {
        rstr = floattype_str_either(npy_crealf(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_crealf(val))) {
    ...
    if (npy_isfinite(npy_cimagf(val))) {
        istr = floattype_str_either(npy_cimagf(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimagf(val))) {
    ...
    if (legacy_print_mode > 125) {
        string = PyUnicode_FromFormat("np.complex64(%S%Sj)", rstr, istr);
    }
    else {
        string = PyUnicode_FromFormat("(%S%Sj)", rstr, istr);
    }
...
{
    PyObject *string;
    string = doubletype_str_either(
            PyArrayScalar_VAL(self, Double),
            TrimMode_LeaveOneZero, TrimMode_DptZeros, 0);
    ...
    if (legacy_print_mode > 125) {
        Py_SETREF(string, PyUnicode_FromFormat("np.float64(%S)", string));
    }
#endif  /* IS_repr */
...
cdoubletype_str(PyObject *self)
{
    ...
    if (npy_creal(val) == 0.0 && npy_signbit(npy_creal(val)) == 0) {
        istr = doubletype_str_either(npy_cimag(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
        ...
        if (legacy_print_mode <= 125) {
            ...
            ret = PyUnicode_FromFormat("np.complex128(%Sj)", istr);
        }
#endif  /* IS_repr */
        Py_DECREF(istr);
        return ret;
    ...
    if (npy_isfinite(npy_creal(val))) {
        rstr = doubletype_str_either(npy_creal(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_creal(val))) {
        rstr = PyUnicode_FromString("nan");
    }
    else if (npy_creal(val) > 0){
        rstr = PyUnicode_FromString("inf");
    ...
    if (npy_isfinite(npy_cimag(val))) {
        istr = doubletype_str_either(npy_cimag(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimag(val))) {
        istr = PyUnicode_FromString("+nan");
    }
    else if (npy_cimag(val) > 0){
        istr = PyUnicode_FromString("+inf");
    ...
    if (legacy_print_mode > 125) {
        string = PyUnicode_FromFormat("np.complex128(%S%Sj)", rstr, istr);
    }
    else {
        string = PyUnicode_FromFormat("(%S%Sj)", rstr, istr);
    }
...
{
    PyObject *string;
    string = longdoubletype_str_either(
            PyArrayScalar_VAL(self, LongDouble),
            TrimMode_LeaveOneZero, TrimMode_DptZeros, 0);
    ...
    if (legacy_print_mode > 125) {
        Py_SETREF(string, PyUnicode_FromFormat("np.longdouble('%S')", string));
    }
#endif  /* IS_repr */
...
clongdoubletype_str(PyObject *self)
{
    ...
    if (npy_creall(val) == 0.0 && npy_signbit(npy_creall(val)) == 0) {
        istr = longdoubletype_str_either(npy_cimagl(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
        ...
        if (legacy_print_mode <= 125) {
            ...
            ret = PyUnicode_FromFormat("np.clongdouble('%Sj')", istr);
        }
#endif  /* IS_repr */
        Py_DECREF(istr);
        return ret;
    ...
    if (npy_isfinite(npy_creall(val))) {
        rstr = longdoubletype_str_either(npy_creall(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_creall(val))) {
        rstr = PyUnicode_FromString("nan");
    }
    else if (npy_creall(val) > 0){
        rstr = PyUnicode_FromString("inf");
    ...
    if (npy_isfinite(npy_cimagl(val))) {
        istr = longdoubletype_str_either(npy_cimagl(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimagl(val))) {
        istr = PyUnicode_FromString("+nan");
    }
    else if (npy_cimagl(val) > 0){
        istr = PyUnicode_FromString("+inf");
    ...
    if (legacy_print_mode > 125) {
        string = PyUnicode_FromFormat("np.clongdouble('%S%Sj')", rstr, istr);
    }
    else {
        string = PyUnicode_FromFormat("(%S%Sj)", rstr, istr);
    }
...
cfloattype_repr(PyObject *self)
{
    ...
    if (npy_crealf(val) == 0.0 && npy_signbit(npy_crealf(val)) == 0) {
        istr = floattype_repr_either(npy_cimagf(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
    ...
    if (npy_isfinite(npy_crealf(val))) {
        rstr = floattype_repr_either(npy_crealf(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_crealf(val))) {
        rstr = PyUnicode_FromString("nan");
    }
    ...
    if (npy_isfinite(npy_cimagf(val))) {
        istr = floattype_repr_either(npy_cimagf(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimagf(val))) {
        istr = PyUnicode_FromString("+nan");
    }
...
cdoubletype_repr(PyObject *self)
{
    ...
    if (npy_creal(val) == 0.0 && npy_signbit(npy_creal(val)) == 0) {
        istr = doubletype_repr_either(npy_cimag(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
    ...
    if (npy_isfinite(npy_creal(val))) {
        rstr = doubletype_repr_either(npy_creal(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_creal(val))) {
        rstr = PyUnicode_FromString("nan");
    }
    ...
    if (npy_isfinite(npy_cimag(val))) {
        istr = doubletype_repr_either(npy_cimag(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimag(val))) {
        istr = PyUnicode_FromString("+nan");
    }
...
{
    PyObject *string;
    string = longdoubletype_repr_either(
            PyArrayScalar_VAL(self, LongDouble),
            TrimMode_LeaveOneZero, TrimMode_DptZeros, 0);
...
clongdoubletype_repr(PyObject *self)
{
    ...
    if (npy_creall(val) == 0.0 && npy_signbit(npy_creall(val)) == 0) {
        istr = longdoubletype_repr_either(npy_cimagl(val), trim, trim, 0);
        if (istr == NULL) {
            return NULL;
        }
        PyObject *ret;
    ...
    if (npy_isfinite(npy_creall(val))) {
        rstr = longdoubletype_repr_either(npy_creall(val), trim, trim, 0);
    }
    else if (npy_isnan(npy_creall(val))) {
        rstr = PyUnicode_FromString("nan");
    }
    ...
    if (npy_isfinite(npy_cimagl(val))) {
        istr = longdoubletype_repr_either(npy_cimagl(val), trim, trim, 1);
    }
    else if (npy_isnan(npy_cimagl(val))) {
        istr = PyUnicode_FromString("+nan");
    }
...
cfloat_complex(PyObject *self, PyObject *NPY_UNUSED(args),
               PyObject *NPY_UNUSED(kwds))
{
    return PyComplex_FromDoubles(npy_crealf(PyArrayScalar_VAL(self, CFloat)),
...
clongdouble_complex(PyObject *self, PyObject *NPY_UNUSED(args),
               PyObject *NPY_UNUSED(kwds))
{
    return PyComplex_FromDoubles(npy_creall(PyArrayScalar_VAL(self, CLongDouble)),
                                 npy_cimagl(PyArrayScalar_VAL(self, CLongDouble)));
}
...
byte_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_BYTE_IS_CDOUBLE) || defined(_BYTE_IS_CFLOAT)
...
short_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_SHORT_IS_CDOUBLE) || defined(_SHORT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
int_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_INT_IS_CDOUBLE) || defined(_INT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
long_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_LONG_IS_CDOUBLE) || defined(_LONG_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
longlong_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_LONGLONG_IS_CDOUBLE) || defined(_LONGLONG_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
ubyte_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_UBYTE_IS_CDOUBLE) || defined(_UBYTE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
ushort_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_USHORT_IS_CDOUBLE) || defined(_USHORT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
uint_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_UINT_IS_CDOUBLE) || defined(_UINT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
ulong_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_ULONG_IS_CDOUBLE) || defined(_ULONG_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
ulonglong_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_ULONGLONG_IS_CDOUBLE) || defined(_ULONGLONG_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
half_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_HALF_IS_CDOUBLE) || defined(_HALF_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
float_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_FLOAT_IS_CDOUBLE) || defined(_FLOAT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
double_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_DOUBLE_IS_CDOUBLE) || defined(_DOUBLE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
longdouble_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_LONGDOUBLE_IS_CDOUBLE) || defined(_LONGDOUBLE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
cfloat_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_CFLOAT_IS_CDOUBLE) || defined(_CFLOAT_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
cdouble_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_CDOUBLE_IS_CDOUBLE) || defined(_CDOUBLE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
clongdouble_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_CLONGDOUBLE_IS_CDOUBLE) || defined(_CLONGDOUBLE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
string_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_STRING_IS_CDOUBLE) || defined(_STRING_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
unicode_arrtype_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    PyObject *obj = NULL;
#if defined(_UNICODE_IS_CDOUBLE) || defined(_UNICODE_IS_CFLOAT)
    static char *kwnames[] = {"", "", NULL};  /* positional-only */
    static char *parse_error = "Could not convert arguments into a complex scalar. '%R' given.";
    PyObject *real_obj = NULL;
    PyObject *imag_obj = NULL;
...
cfloat_arrtype_hash(PyObject *obj)
{
    ...
    hashreal = Npy_HashDouble(
            obj, (double)npy_crealf(PyArrayScalar_VAL(obj, CFloat)));

    if (hashreal == -1) {
        return -1;
    }
    hashimag = Npy_HashDouble(
            obj, (double)npy_cimagf(PyArrayScalar_VAL(obj, CFloat)));
    if (hashimag == -1) {
        return -1;
    }
...
clongdouble_arrtype_hash(PyObject *obj)
{
    npy_hash_t hashreal, hashimag, combined;
    hashreal = Npy_HashDouble(
            obj, (double)npy_creall(PyArrayScalar_VAL(obj, CLongDouble)));

    if (hashreal == -1) {
        return -1;
    }
    hashimag = Npy_HashDouble(
            obj, (double)npy_cimagl(PyArrayScalar_VAL(obj, CLongDouble)));
    if (hashimag == -1) {
        return -1;
    }
    combined = hashreal + 1000003 * hashimag;
